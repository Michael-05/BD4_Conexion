...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Insertar crédito personal
        $finalidad = $_POST['finalidad_credito'];
        $sqlPersonal = "INSERT INTO creditos_personal (credito_id, finalidad_credito) VALUES ($1, $2)";
        $result = pg_query_params($conex, $sqlPersonal, [$credito_id, $finalidad]);
        
        if (!$result) {
            throw new Exception('Error al guardar crédito personal: ' . pg_last_error($conex));
        }
